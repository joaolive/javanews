...
public class PostController {
	...
	public PostController(FindPostByIdUseCase findPostByIdUseCase, CreatePostUseCase createPostUseCase) {
	...
	public ResponseEntity<PostResponse> createPost(
			@Valid @RequestBody CreatePostRequest request, @AuthenticationPrincipal Jwt jwt) {
